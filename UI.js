...
function SetUpUI(){
  ...
  if (Device == "Laptop"){
    ...
    KillAllButton = createButton("Kill All");
    KillAllButton.position(windowWidth / 2 - displayWidth / 7, 50);
...
function ApplyUI(Camera){
  ...
  textSize(20);
  fill(255);
  text(round(frameRate()) + "FPS", 10, windowHeight - 20);
  text("v1.2", windowWidth - 50, windowHeight - 20);
  fill(246, 202, 9);
